...
// Keycodes
    ...
    QK_DYNAMIC_MACRO_DYNAMIC_DELAY_UP = 0x7C7B,
    QK_DYNAMIC_MACRO_DYNAMIC_DELAY_DOWN = 0x7C7C,
    QK_DYNAMIC_MACRO_DYNAMIC_DELAY_RESET = 0x7C7D,
    QK_KB_0 = 0x7E00,
    QK_KB_1 = 0x7E01,
    QK_KB_2 = 0x7E02,
    QK_KB_3 = 0x7E03,
...
// Alias
    ...
    DM_DYNU    = QK_DYNAMIC_MACRO_DYNAMIC_DELAY_UP,
    DM_DYND    = QK_DYNAMIC_MACRO_DYNAMIC_DELAY_DOWN,
    DM_DYNR    = QK_DYNAMIC_MACRO_DYNAMIC_DELAY_RESET,
};
...
#define IS_QUANTUM_KEYCODE(code) ((code) >= QK_BOOTLOADER && (code) <= QK_DYNAMIC_MACRO_DYNAMIC_DELAY_RESET)
...
#define QUANTUM_KEYCODE_RANGE               QK_BOOTLOADER ... QK_DYNAMIC_MACRO_DYNAMIC_DELAY_RESET
