...
// Keycodes
    ...
    QK_DYNAMIC_MACRO_WAIT_1 = 0x7C7B,
    QK_DYNAMIC_MACRO_WAIT_2 = 0x7C7C,
    QK_DYNAMIC_MACRO_WAIT_3 = 0x7C8D,
    QK_KB_0 = 0x7E00,
    QK_KB_1 = 0x7E01,
    QK_KB_2 = 0x7E02,
    QK_KB_3 = 0x7E03,
...
// Alias
    ...
    DM_WT1     = QK_DYNAMIC_MACRO_WAIT_1,
    DM_WT2     = QK_DYNAMIC_MACRO_WAIT_2,
    DM_WT3     = QK_DYNAMIC_MACRO_WAIT_3,
};
...
#define IS_QUANTUM_KEYCODE(code) ((code) >= QK_BOOTLOADER && (code) <= QK_DYNAMIC_MACRO_WAIT_3)
...
#define QUANTUM_KEYCODE_RANGE               QK_BOOTLOADER ... QK_DYNAMIC_MACRO_WAIT_3
