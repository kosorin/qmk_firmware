...
std::map<uint16_t, std::string> KEYCODE_ID_TABLE = {
    ...
    {QK_DYNAMIC_MACRO_DYNAMIC_DELAY_UP, "QK_DYNAMIC_MACRO_DYNAMIC_DELAY_UP"},
    {QK_DYNAMIC_MACRO_DYNAMIC_DELAY_DOWN, "QK_DYNAMIC_MACRO_DYNAMIC_DELAY_DOWN"},
    {QK_DYNAMIC_MACRO_DYNAMIC_DELAY_RESET, "QK_DYNAMIC_MACRO_DYNAMIC_DELAY_RESET"},
    {QK_KB_0, "QK_KB_0"},
    {QK_KB_1, "QK_KB_1"},
    {QK_KB_2, "QK_KB_2"},
    {QK_KB_3, "QK_KB_3"},
